...
async def start_yukki():
    ...
    print("\n💥💥 5P4MX UBOT v3.1.1.11 beta6 IS STARTING... 💥💥\n")
...
🤖 𝘽𝙤𝙩 𝙄𝙣𝙛𝙤 
- version : <code>v3.1.1.11 beta6</code>
- type \t\t: <code>DLX</code>
...
💥💥 [CONGRATULATIONS] UR DLX A50X 5P4MX UBOT v3.1.1.11 beta6 IS READY! 💥💥
