...
async def start_yukki():
    ...
    print("\n💥💥 BOT DEADLY ALPHA-X MULT1 5P4MX UBOT v3.1.1.9  IS STARTING... 💥💥\n")
...
💥💥 [CONGRATULATIONS] \nUR DEADLY ALPHA-X MULT1 A50X 5P4MX UBOT v3.1.1.9 IS READY! 💥💥
💥💥 Modded Code By @AlphaxProject Team 💥💥"""

print(text)
print("")
print("🔥🔥 SMEX! DEADLY ALPHA-X MULT1 5P4MX UBOT v3.1.1.9 STARTED SUCCESFULLY!. 🔥🔥")
